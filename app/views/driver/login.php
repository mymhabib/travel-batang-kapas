<script>
    ...
    if (performance.navigation.type == 1){
        window.location.href = "<?= BASEURL; ?>driver/login";
    }
</script>
<head>
<meta charset="UTF-8">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-lg-8 mx-auto">
                            <h2 class="login-heading mb-4 text-center">Masuk Sebagai Driver</h2>
                            <!-- Sign In Form -->
                            <form class="row g-3" style="margin-top: 10px; position: center; padding-left: 5px;" action="<?= BASEURL; ?>driver/login" method="POST">
